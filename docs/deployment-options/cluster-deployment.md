...
- [Kubernetes-specific configuration](#kubernetes-specific-configuration) — [GKE](#gke-google-kubernetes-engine)
...
Some Kubernetes distributions require additional configuration to integrate with JellyCloud or the cloud services your cluster already uses. This section covers the steps needed for each environment.

### GKE (Google Kubernetes Engine)

When your cluster runs on GKE and your workloads pull images from Google Artifact Registry, you can use GCP Workload Identity to grant JellyCloud nodes pull access without storing credentials in the cluster.
